  ...
  useMemo(() => {
    ...
    const clearExtra = () => {
      ...
      const res = polygons8.filter((el, index) => {
        ...
        for (let i = 0; i < polygons6.length; i++) {
          if (el.includes(polygons6[i][0]) && el.includes(polygons6[i][1]) && el.includes(polygons6[i][2]) && el.includes(polygons6[i][3]) && el.includes(polygons6[i][4]) && el.includes(polygons6[i][5])) {
            status = false;
            break;
          }
        }
