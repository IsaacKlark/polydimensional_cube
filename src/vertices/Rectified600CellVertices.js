const Rectified600CellVertices = (
  dimensions,
  DimensionOfFigure,
  setVerticesArray,
  scale,
  ...
  const fi = 1.618;
  const baseGroup1 = [0, 0, 2 * fi, 2 * fi ** 2].map((number) =>
    Math.round(number * 30)
  );
  const baseGroup2 = [1, 1, fi ** 3, fi ** 3].map((number) =>
    Math.round(number * 30)
  );
  const baseGroup3 = [0, 1, fi, 1 + 3 * fi].map((number) =>
    Math.round(number * 30)
  );
  const baseGroup4 = [0, fi ** 2, fi ** 3, 2 + fi].map((number) =>
    Math.round(number * 30)
  );
  const baseGroup5 = [1, fi, 2 * fi ** 2, fi ** 2].map((number) =>
    Math.round(number * 30)
  );
  const baseGroup6 = [fi, fi ** 2, 2 * fi, fi ** 3].map((number) =>
    Math.round(number * 30)
  );
...
export default Rectified600CellVertices;
