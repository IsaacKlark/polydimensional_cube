const Runcitruncated600CellVertices = (
  dimensions,
  DimensionOfFigure,
  setVerticesArray,
  scale,
  ...
  const baseGroup2 = [1, 1, fi**3, 3+8*fi].map((number) => Math.trunc(number * length));
  const baseGroup3 = [1, 1, 1+4*fi, 5+6*fi].map((number) => Math.trunc(number * length));
  const baseGroup4 = [fi**2, 3+fi, fi**5, fi**5].map((number) => Math.trunc(number * length));
  const baseGroup5 = [2+fi, 2+fi, 2+5*fi, 4+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup6 = [3*fi, fi**4, 2+5*fi, 2+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup7 = [1+3*fi, 1+3*fi, 1+5*fi, fi**5].map((number) => Math.trunc(number * length));
  const baseGroup8 = [0, 1, 2+5*fi, 5*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup9 = [0, fi**2, 3+8*fi, 2+fi].map((number) => Math.trunc(number * length));
  const baseGroup10 = [0, fi**3, 4+7*fi, 3+fi].map((number) => Math.trunc(number * length));
  const baseGroup11 = [0, 2*fi**2, 2+6*fi, 4*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup12 = [0, 1+3*fi, 3*fi**3, 4+3*fi].map((number) => Math.trunc(number * length));
  const baseGroup13 = [1, fi, 2*fi**4, 1+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup14 = [1, 2, fi**5, 4+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup15 = [1, 2, 1+3*fi, 4+7*fi].map((number) => Math.trunc(number * length));
  const baseGroup16 = [1, 2+fi, 2+6*fi, fi**5].map((number) => Math.trunc(number * length));
  const baseGroup17 = [1, fi**3, 5+6*fi, 3+2*fi].map((number) => Math.trunc(number * length));
  const baseGroup18 = [1, 3*fi, 2*fi**4, 3*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup19 = [1, 3*fi**2, 2+5*fi, 4*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup20 = [1, 2*fi**3, fi**5, 4+3*fi].map((number) => Math.trunc(number * length));
  const baseGroup21 = [fi, fi**2, 2*fi, 3+8*fi].map((number) => Math.trunc(number * length));
  const baseGroup22 = [fi, 2+fi, 3*fi, 4+7*fi].map((number) => Math.trunc(number * length));
  const baseGroup23 = [fi, 3+2*fi, fi**5, 4*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup24 = [fi, fi**4, 4+5*fi, 4+3*fi].map((number) => Math.trunc(number * length));
  const baseGroup25 = [2, fi**2, 3*fi**3, 2+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup26 = [2, fi**2, 5+6*fi, fi**4].map((number) => Math.trunc(number * length));
  const baseGroup27 = [2, 2*fi, 2*fi**4, 2*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup28 = [fi**2, 3*fi, 5+6*fi, 2*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup29 = [fi**2, 1+3*fi, 5*fi**2, 3*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup30 = [fi**2, 3*fi**2, 1+5*fi, fi**5].map((number) => Math.trunc(number * length));
  const baseGroup31 = [2*fi, 2+fi, 1+3*fi, 5+6*fi].map((number) => Math.trunc(number * length));
  const baseGroup32 = [2*fi, 3+2*fi, 2+5*fi, fi**5].map((number) => Math.trunc(number * length));
  const baseGroup33 = [2*fi, 1+4*fi, 4+5*fi, 3*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup34 = [2+fi, fi**3, 5*fi**2, 2*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup35 = [2+fi, 1+3*fi, 2*fi**4, 3+2*fi].map((number) => Math.trunc(number * length));
  const baseGroup36 = [fi**3, 3+fi, fi**4, 2*fi**4].map((number) => Math.trunc(number * length));
  const baseGroup37 = [fi**3, 2*fi**2, 1+5*fi, 4+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup38 = [fi**3, 3+2*fi, 1+4*fi, 3*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup39 = [fi**3, 2*fi**3, 1+5*fi, 2+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup40 = [3*fi, 1+4*fi, fi**5, 2*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup41 = [1+3*fi, fi**4, 1+4*fi, 2+6*fi].map((number) => Math.trunc(number * length));
...
export default Runcitruncated600CellVertices;
