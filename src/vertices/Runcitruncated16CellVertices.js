const Runcitruncated16CellVertices = (
  dimensions,
  DimensionOfFigure,
  setVerticesArray,
  scale,
  ...
  for (let i = 0; i < +DimensionOfFigure; i++) {
    if (i === +DimensionOfFigure - 2) {
      baseGroup1.push((1 + Math.sqrt(2)) * 35)
    } else if (i === +DimensionOfFigure - 1) {
      baseGroup1.push((1 + 2* Math.sqrt(2)) * 35)
...
export default Runcitruncated16CellVertices;
