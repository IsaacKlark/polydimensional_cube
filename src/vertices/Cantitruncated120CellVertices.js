const Cantitruncated120CellVertices = (
  dimensions,
  DimensionOfFigure,
  setVerticesArray,
  scale,
  ...
  const baseGroup2 = [1, 1, 1+4*fi, 5+10*fi].map((number) => Math.trunc(number * length));
  const baseGroup3 = [1+3*fi, 3*fi**2, 3+7*fi, 3+7*fi].map((number) => Math.trunc(number * length));
  const baseGroup4 = [fi**4,fi**4, 2+7*fi, 4+7*fi].map((number) => Math.trunc(number * length));
  const baseGroup5 = [0, 1, 6+7*fi, 3+7*fi].map((number) => Math.trunc(number * length));
  const baseGroup6 = [0, 1, 6+9*fi, 1+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup7 = [0,fi**2,fi**6, 2+7*fi].map((number) => Math.trunc(number * length));
  const baseGroup8 = [0,fi**2, 7+8*fi, 2+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup9 = [0, 2*fi, 6+8*fi, 2+6*fi].map((number) => Math.trunc(number * length));
  const baseGroup10 = [1, 4+5*fi, 2*fi**4, 5*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup11 = [1, 2, 5+7*fi, 4+7*fi].map((number) => Math.trunc(number * length));
  const baseGroup12 = [1, 2+fi, 4*fi**3, 3+7*fi].map((number) => Math.trunc(number * length));
  const baseGroup13 = [1,fi**3, 7+8*fi, 3+4*fi].map((number) => Math.trunc(number * length));
  const baseGroup14 = [1,fi**3, 5+10*fi, 3+2*fi].map((number) => Math.trunc(number * length));
  const baseGroup15 = [1, 3*fi, 6+8*fi,fi**5].map((number) => Math.trunc(number * length));
  const baseGroup16 = [1,fi**4, 4*fi**3, 5*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup17 = [2,fi**2, 5+10*fi,fi**4].map((number) => Math.trunc(number * length));
  const baseGroup18 = [2,fi**3, 6+9*fi, 3*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup19 = [2, 2*fi**2, 4*fi**3, 2*fi**4].map((number) => Math.trunc(number * length));
  const baseGroup20 = [2, 1+3*fi,fi**6, 4+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup21 = [fi**2,fi**5, 3+7*fi, 5*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup22 = [fi**2, 3*fi, 5+10*fi, 2*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup23 = [fi**2, 3*fi**2, 5+7*fi, 5*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup24 = [2*fi, 2+fi, 1+3*fi, 5+10*fi].map((number) => Math.trunc(number * length));
  const baseGroup25 = [2*fi, 3+4*fi, 4+7*fi, 5*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup26 = [2+fi, 3*fi, 6+9*fi,fi**4].map((number) => Math.trunc(number * length));
  const baseGroup27 = [2+fi, 3+2*fi, 5+7*fi, 2*fi**4].map((number) => Math.trunc(number * length));
  const baseGroup28 = [2+fi,fi**4, 6+7*fi, 4+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup29 = [fi**3,fi**5, 2+7*fi, 2*fi**4].map((number) => Math.trunc(number * length));
  const baseGroup30 = [fi**3, 2+6*fi, 3+7*fi, 4+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup31 = [3*fi, 2+5*fi, 4+7*fi, 4+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup32 = [3*fi, 3+4*fi, 3+7*fi, 2*fi**4].map((number) => Math.trunc(number * length));
  const baseGroup33 = [2*fi**2, 1+3*fi, 7+8*fi,fi**4].map((number) => Math.trunc(number * length));
  const baseGroup34 = [2*fi**2, 3+2*fi, 4+7*fi, 3+7*fi].map((number) => Math.trunc(number * length));
  const baseGroup35 = [2*fi**2, 1+4*fi, 6+7*fi,fi**5].map((number) => Math.trunc(number * length));
  const baseGroup36 = [1+3*fi, 1+5*fi, 5+7*fi,fi**5].map((number) => Math.trunc(number * length));
  const baseGroup37 = [3+2*fi,fi**4, 6+8*fi, 3*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup38 = [3+2*fi, 1+4*fi,fi**6, 3+4*fi].map((number) => Math.trunc(number * length));
  const baseGroup39 = [fi**4, 1+4*fi, 5+7*fi, 2+6*fi].map((number) => Math.trunc(number * length));
  const baseGroup40 = [fi**4, 1+5*fi, 4*fi**3, 3+4*fi].map((number) => Math.trunc(number * length));
  const baseGroup41 = [1+4*fi, 3*fi**2, 2+5*fi, 4*fi**3].map((number) => Math.trunc(number * length));
...
export default Cantitruncated120CellVertices;
