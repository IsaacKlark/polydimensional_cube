const RuncitruncatedTesseractVertices = (
  dimensions,
  DimensionOfFigure,
  setVerticesArray,
  scale,
  ...
  const baseGroup1 = [30, (1 + 2 * Math.sqrt(2)) * 30];

  for (let i = 2; i < +DimensionOfFigure; i++) {
    baseGroup1.splice(1, 0, (1 + Math.sqrt(2)) * 30);
  }
...
export default RuncitruncatedTesseractVertices;
