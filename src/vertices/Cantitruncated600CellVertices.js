const Cantitruncated600CellVertices = (
  dimensions,
  DimensionOfFigure,
  setVerticesArray,
  scale,
  ...
  const fi = 1.618;
  const length = 10;
  const baseGroup1 = [1, 1, 1+6*fi, 5+6*fi].map((number) => Math.trunc(number * length));
  const baseGroup2 = [1, 3, 3+6*fi, 3+6*fi].map((number) => Math.trunc(number * length));
  const baseGroup3 = [2, 2, 2+6*fi, 2*fi**4].map((number) => Math.trunc(number * length));
  const baseGroup4 = [0, 1, 3*fi, 3+9*fi].map((number) => Math.trunc(number * length));
  const baseGroup5 = [0, 1, 5*fi, 5+7*fi].map((number) => Math.trunc(number * length));
  const baseGroup6 = [0, 2, 4*fi, 4*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup7 = [0, 4+3*fi, fi**5, 5+4*fi].map((number) => Math.trunc(number * length));
  const baseGroup8 = [0, 3+4*fi, 4+5*fi, 5+3*fi].map((number) => Math.trunc(number * length));
  const baseGroup9 = [1, fi, 6*fi**2, 1+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup10 = [1, 2*fi, 3+9*fi, 2+fi].map((number) => Math.trunc(number * length));
  const baseGroup11 = [1, 3+fi, 3*fi, 4*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup12 = [1, 3*fi, 6*fi**2, 3*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup13 = [1, 3+2*fi, 3*fi**3, 5+4*fi].map((number) => Math.trunc(number * length));
  const baseGroup14 = [1, fi**4, 2*fi**4, 5+3*fi].map((number) => Math.trunc(number * length));
  const baseGroup15 = [fi, 2, fi**3, 3+9*fi].map((number) => Math.trunc(number * length));
  const baseGroup16 = [fi, 3, 1+3*fi, 4*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup17 = [fi, 3*fi**2, 2+6*fi, 5+4*fi].map((number) => Math.trunc(number * length));
  const baseGroup18 = [fi, 2*fi**3, 3*fi**3, 5+3*fi].map((number) => Math.trunc(number * length));
  const baseGroup19 = [2, 2*fi, 6*fi**2, 2*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup20 = [2, 3+fi, 3*fi**3, 4+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup21 = [2, 3*fi, 5+7*fi, 3+2*fi].map((number) => Math.trunc(number * length));
  const baseGroup22 = [2, 1+3*fi, 5+6*fi, 4+3*fi].map((number) => Math.trunc(number * length));
  const baseGroup23 = [3, 2*fi, 5+7*fi, fi**4].map((number) => Math.trunc(number * length));
  const baseGroup24 = [3, 2+fi, 2*fi**4, fi**5].map((number) => Math.trunc(number * length));
  const baseGroup25 = [3, fi**3, 5+6*fi, 3+4*fi].map((number) => Math.trunc(number * length));
  const baseGroup26 = [2*fi, 3*fi**2, 1+6*fi, 4+5*fi].map((number) => Math.trunc(number * length));
  const baseGroup27 = [2*fi, 4+3*fi, 1+5*fi, 3*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup28 = [2+fi, 3+fi, 2+6*fi, 3*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup29 = [2+fi, 1+3*fi, 6*fi**2, 3+2*fi].map((number) => Math.trunc(number * length));
  const baseGroup30 = [2+fi, 4*fi, 5+6*fi, 3*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup31 = [fi**3, 3+fi, fi**4, 6*fi**2].map((number) => Math.trunc(number * length));
  const baseGroup32 = [fi**3, 3+2*fi, 1+6*fi, 3*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup33 = [fi**3, 3*fi**2, 5*fi, 2*fi**4].map((number) => Math.trunc(number * length));
  const baseGroup34 = [3+fi, 3*fi, 5+6*fi, 2*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup35 = [3*fi, 3+2*fi, 1+5*fi, 2*fi**4].map((number) => Math.trunc(number * length));
  const baseGroup36 = [3*fi, 2*fi**3, 1+6*fi, fi**5].map((number) => Math.trunc(number * length));
  const baseGroup37 = [3*fi, 1+5*fi, 2+6*fi, 3+4*fi].map((number) => Math.trunc(number * length));
  const baseGroup38 = [1+3*fi, fi**4, 1+6*fi, 2+6*fi].map((number) => Math.trunc(number * length));
  const baseGroup39 = [1+3*fi, 5*fi, 3*fi**3, 2*fi**3].map((number) => Math.trunc(number * length));
  const baseGroup40 = [4*fi, fi**4, 1+5*fi, 3*fi**3].map((number) => Math.trunc(number * length));
...
export default Cantitruncated600CellVertices;
